...
impl Animations {
    ...
    /// Returns true if animations are running and there are no pending animations events to deliver.
    /// This is used to update the animation state in the `Constellation`.
