...
impl WebView {
    ...
    pub(crate) fn send_image_update_for_pipeline(&self, pipeline_id: PipelineId) {
        // Notify the script thread to update the image,
    }
    ...
    pub(crate) fn set_frame_tree_on_pipeline_details(
        ...
        pipeline_details.pipeline = Some(frame_tree.pipeline.clone()); // frame tree contains pipeline details.
